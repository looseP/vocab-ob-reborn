...
export const apiOperations = [
  ...
  operation("post", "/api/l3/sources/:id/captures", "createL3SelectionCapture", "owner", "sessionMutation", { body: l3SelectionCaptureSchema }, 201, l3SelectionCaptureResponseSchema),
  ...
  operation("post", "/api/l3/quick-context", "createL3QuickContext", "owner", "sessionMutation", { body: quickL3ContextSchema }, 201, l3QuickContextResponseSchema),
