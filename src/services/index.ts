...
import { L3StudyNoteExportService } from "./l3-study-note-export.service";
...
export function createServices(deps: ServiceDeps) {
  ...
  return {
    ...
    words: new WordService(repos.words, withTransaction, createRepositories),
    ...
    // N1/Task 10：笔记导出（只读共享锁事务；text/markdown + 版本/sha256 响应头）。
