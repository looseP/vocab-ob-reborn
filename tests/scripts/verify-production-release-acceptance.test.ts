...
const check = { status: "passed", source: "github-environment", observedAt, evidenceSha256: "c".repeat(64) };
...
describe("production release acceptance", () => {
  it("accepts bound GO evidence", () => expect(verify()).toEqual({ schemaVersion: 1, decision: "GO", releaseSha, manifestSha256, environment: "production" }));
